...
import com.origamisoftware.teach.advanced.entities.EntityDOA;
import com.origamisoftware.teach.advanced.entities.EntityDOA;
...
public class DatabaseUtils {
   ...
   */
    ...
    public static <T extends EntityDOA> T findUniqueResultBy(String property,
                                                                         Object value,
                                                                         Class T,
     ...
     */
    @SuppressWarnings("unchecked")  // API requires unchecked OK per guidelines
    public static <T extends EntityDOA> List<T> findResultsBy(String property,
                                                                          Object value,
                                                                          Class T,
                                                                          boolean handleTransaction) {
        Session session = null;
